...
ARG NUXT_PUBLIC_STREAM_URL
ARG NUXT_PUBLIC_STREAM_SSE_URL
ARG NUXT_PUBLIC_API_URL
ARG NUXT_PUBLIC_API_METADATA_ENDPOINT
ARG NUXT_PUBLIC_API_KEY

# Set environment variables for Nuxt build
ENV NUXT_PUBLIC_STREAM_URL=${NUXT_PUBLIC_STREAM_URL}
ENV NUXT_PUBLIC_STREAM_SSE_URL=${NUXT_PUBLIC_STREAM_SSE_URL}
ENV NUXT_PUBLIC_API_URL=${NUXT_PUBLIC_API_URL}
ENV NUXT_PUBLIC_API_METADATA_ENDPOINT=${NUXT_PUBLIC_API_METADATA_ENDPOINT}
ENV NUXT_PUBLIC_API_KEY=${NUXT_PUBLIC_API_KEY}
