...
<template>
  <div v-if="publicThemes.length" :class="cn('absolute right-8 top-1/2 z-50 -translate-y-1/2', $attrs.class)">
    <Toggler v-model:model-value="current" direction="vertical" @update:model-value="handleChange">
